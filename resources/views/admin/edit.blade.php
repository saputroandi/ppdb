...
@section('content')
    <form action="/form/{{$user->form->id}}" method="post">
        {{ csrf_field() }}
        @method('PATCH')
        <div class="form-group row">
            <label for="inputName" class="col-sm-2 col-form-label">Name</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="inputName" value="{{$user->form->name}}" name="name">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select class="custom-select" name="gender" value="{{$user->form->gender}}">
                    <option selected value="{{$user->form->gender}}">{{$user->form->gender}}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="date" class="form-control" id="inputDate" name="date_of_birth" value="{{$user->form->date_of_birth}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="inputReligion" name="religion" value="{{$user->form->religion}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputFather" name="name_of_father" value="{{$user->form->name_of_father}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputMother" name="name_of_mother" value="{{$user->form->name_of_mother}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputPhone1" name="phone_number_1" value="{{$user->form->phone_number_1}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputPhone2" name="phone_number_2" value="{{$user->form->phone_number_2}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputDistric" name="district" value="{{$user->form->district}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputSubDistric" name="sub_district" value="{{$user->form->sub_district}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputUrbanV" name="urban_village" value="{{$user->form->urban_village}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputAddress" name="address" value="{{$user->form->address}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputZip" name="zip_code" value="{{$user->form->zip_code}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputJHS" name="from_jhs" value="{{$user->form->from_jhs}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNISN" name="nisn" value="{{$user->form->nisn}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputKK" name="no_kk" value="{{$user->form->no_kk}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKStudent" name="nik_of_student" value="{{$user->form->nik_of_student}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKFather" name="nik_of_father" value="{{$user->form->nik_of_father}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKMother" name="nik_of_mother" value="{{$user->form->nik_of_mother}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputFatherOccupation" name="father_occupation" value="{{$user->form->father_occupation}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputMotherOccupation" name="mother_occupation" value="{{$user->form->mother_occupation}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputInterest" name="majors_interest" value="{{$user->form->majors_interest}}">
