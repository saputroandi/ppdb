...
@section('content')
    <form action="/form/{{$user->id}}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="date" class="form-control" id="inputDate" name="date_of_birth" value="{{$user->date_of_birth}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="inputReligion" name="religion" value="{{$user->religion}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputFather" name="name_of_father" value="{{$user->name_of_father}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputMother" name="name_of_mother" value="{{$user->name_of_mother}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputPhone1" name="phone_number_1" value="{{$user->phone_number_1}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputPhone2" name="phone_number_2" value="{{$user->phone_number_2}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputDistric" name="district" value="{{$user->district}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputSubDistric" name="sub_district" value="{{$user->sub_district}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputUrbanV" name="urban_village" value="{{$user->urban_village}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputZip" name="zip_code" value="{{$user->zip_code}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputJHS" name="from_jhs" value="{{$user->from_jhs}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNISN" name="nisn" value="{{$user->nisn}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputKK" name="no_kk" value="{{$user->no_kk}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKStudent" name="nik_of_student" value="{{$user->nik_of_student}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKFather" name="nik_of_father" value="{{$user->nik_of_father}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="InputNIKMother" name="nik_of_mother" value="{{$user->nik_of_mother}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputFatherOccupation" name="father_occupation" value="{{$user->father_occupation}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputMotherOccupation" name="mother_occupation" value="{{$user->mother_occupation}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="text" class="form-control" id="InputInterest" name="majors_interest" value="{{$user->majors_interest}}">
            <small style="color: red;">@error('majors_interest'){{$message}}@enderror</small>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-2"><a href="/form/{{$user->id}}" class="btn btn-secondary">Back</a></div>
